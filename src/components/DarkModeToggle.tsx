...
function DarkModeToggle() {
  ...
  // Add a class to the HTML root element to enable or disable dark mode
  useEffect(() => {
    if (isDarkMode) {
  ...
  return (
    <div className="flex rounded-full bg-gray-100 ">
      <button
        className="px-2 py-2 rounded-full bg-gray-100 hover:text-blue-800 text-black  hover:bg-gray-300 hover:-rotate-45 transition-all  "
